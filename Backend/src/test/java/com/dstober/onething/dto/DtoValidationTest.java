...
class DtoValidationTest {
    ...
    @Test
    void taskCreateRequest_PriorityMin_Boundary1_Valid() {
        TaskCreateRequest request = new TaskCreateRequest("Task", 1L, TimeBracket.UNDER_FIFTEEN, 1, null);
    ...
    @Test
    void taskCreateRequest_PriorityMin_Boundary0_Invalid() {
        TaskCreateRequest request = new TaskCreateRequest("Task", 1L, TimeBracket.UNDER_FIFTEEN, 0, null);
    ...
    @Test
    void taskCreateRequest_PriorityMax_Boundary3_Valid() {
        TaskCreateRequest request = new TaskCreateRequest("Task", 1L, TimeBracket.UNDER_FIFTEEN, 3, null);
    ...
    @Test
    void taskCreateRequest_PriorityMax_Boundary4_Invalid() {
        TaskCreateRequest request = new TaskCreateRequest("Task", 1L, TimeBracket.UNDER_FIFTEEN, 4, null);
    ...
    void taskCreateRequest_NameBlank() {
        TaskCreateRequest request = new TaskCreateRequest("", 1L, TimeBracket.UNDER_FIFTEEN, 2, null);
